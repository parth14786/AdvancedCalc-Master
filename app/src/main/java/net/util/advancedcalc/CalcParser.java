...
public class CalcParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>",
			"<EOR>", "<DOWN>", "<UP>", "PLUS", "MINUS", "MULT", "DIV",
			"LPAREN", "RPAREN", "SIN", "COS", "TAN", "LN", "LOG", "FACT",
			"POWER", "E", "PI", "SQRT", "DECIMALPOINT", "DIGIT", "DECIMAL",
			"WHITESPACE" };
	...
	// $ANTLR start "expr"
	// CalcParser.g:34:1: expr returns [double value] : a= multExpr ( PLUS b=
	// multExpr | MINUS b= multExpr )* ;
	public final double expr() throws RecognitionException {
		...
		try {
			// CalcParser.g:35:1: (a= multExpr ( PLUS b= multExpr | MINUS b=
			// multExpr )* )
			// CalcParser.g:35:3: a= multExpr ( PLUS b= multExpr | MINUS b=
			// multExpr )*
			{
	...
	// CalcParser.g:40:1: multExpr returns [double value] : a= powExpr ( MULT b=
	// powExpr | DIV b= powExpr )* ;
	...
	// $ANTLR start "powExpr"
	// CalcParser.g:46:1: powExpr returns [double value] : a= minusExpr ( POWER
	// b= minusExpr )? ;
	...
	// CalcParser.g:50:1: minusExpr returns [double value] : ( (min+= MINUS )+
	// multTerms | multTerms );
	public final double minusExpr() throws RecognitionException {
		...
		try {
			...
			if ((LA5_0 == MINUS)) {
				alt5 = 1;
			} else if ((LA5_0 == LPAREN || (LA5_0 >= SIN && LA5_0 <= LOG)
					|| (LA5_0 >= E && LA5_0 <= SQRT) || LA5_0 == DECIMAL)) {
				alt5 = 2;
			} else {
			...
			// CalcParser.g:51:3: (min+= MINUS )+ multTerms
			{
				...
				loop4: do {
					...
					{
						min = (Token) match(input, MINUS,
								FOLLOW_MINUS_in_minusExpr179);
						if (list_min == null)
		...
		try {
			...
			// CalcParser.g:63:1: ( unaryExpr )+
			{
				...
				loop6: do {
					...
					if ((LA6_0 == LPAREN || (LA6_0 >= SIN && LA6_0 <= LOG)
							|| (LA6_0 >= E && LA6_0 <= SQRT) || LA6_0 == DECIMAL)) {
						alt6 = 1;
					}
	...
	// CalcParser.g:66:1: unaryExpr returns [double value] : ( (sqrt+= SQRT )+
	// factExpr | factExpr );
	public final double unaryExpr() throws RecognitionException {
		...
		try {
			...
			if ((LA8_0 == SQRT)) {
				alt8 = 1;
			} else if ((LA8_0 == LPAREN || (LA8_0 >= SIN && LA8_0 <= LOG)
					|| (LA8_0 >= E && LA8_0 <= PI) || LA8_0 == DECIMAL)) {
				alt8 = 2;
			} else {
			...
			// CalcParser.g:67:3: (sqrt+= SQRT )+ factExpr
			{
				...
				loop7: do {
					...
					{
						sqrt = (Token) match(input, SQRT,
								FOLLOW_SQRT_in_unaryExpr251);
						if (list_sqrt == null)
							list_sqrt = new ArrayList();
						list_sqrt.add(sqrt);
		...
		try {
			...
			// CalcParser.g:71:3: term (fact+= FACT )*
			{
				...
				loop9: do {
					...
					{
						fact = (Token) match(input, FACT,
								FOLLOW_FACT_in_factExpr285);
						if (list_fact == null)
							list_fact = new ArrayList();
						list_fact.add(fact);
	...
	// $ANTLR start "term"
	// CalcParser.g:78:1: term returns [double value] : ( LPAREN expr RPAREN |
	// LN LPAREN expr RPAREN | LOG LPAREN expr RPAREN | SIN LPAREN expr RPAREN |
	// COS LPAREN expr RPAREN | TAN LPAREN expr RPAREN | DECIMAL | PI | E );
	public final double term() throws RecognitionException {
		...
		try {
			// CalcParser.g:79:1: ( LPAREN expr RPAREN | LN LPAREN expr RPAREN |
			// LOG LPAREN expr RPAREN | SIN LPAREN expr RPAREN | COS LPAREN expr
			// RPAREN | TAN LPAREN expr RPAREN | DECIMAL | PI | E )
			int alt10 = 9;
			switch (input.LA(1)) {
			case LPAREN: {
				alt10 = 1;
			...
			{
				DECIMAL14 = (Token) match(input, DECIMAL,
						FOLLOW_DECIMAL_in_term367);
				value = Helper.DecimalToDouble((DECIMAL14 != null ? DECIMAL14
						.getText() : null));
	...
	public static final BitSet FOLLOW_expr_in_ultimate33 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_multExpr_in_expr52 = new BitSet(
			new long[] { 0x0000000000000032L });
	public static final BitSet FOLLOW_PLUS_in_expr59 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_multExpr_in_expr65 = new BitSet(
			new long[] { 0x0000000000000032L });
	public static final BitSet FOLLOW_MINUS_in_expr72 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_multExpr_in_expr78 = new BitSet(
			new long[] { 0x0000000000000032L });
	public static final BitSet FOLLOW_powExpr_in_multExpr98 = new BitSet(
			new long[] { 0x00000000000000C2L });
	public static final BitSet FOLLOW_MULT_in_multExpr105 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_powExpr_in_multExpr111 = new BitSet(
			new long[] { 0x00000000000000C2L });
	public static final BitSet FOLLOW_DIV_in_multExpr118 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_powExpr_in_multExpr126 = new BitSet(
			new long[] { 0x00000000000000C2L });
	public static final BitSet FOLLOW_minusExpr_in_powExpr146 = new BitSet(
			new long[] { 0x0000000000010002L });
	public static final BitSet FOLLOW_POWER_in_powExpr153 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_minusExpr_in_powExpr159 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_MINUS_in_minusExpr179 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_multTerms_in_minusExpr183 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_multTerms_in_minusExpr190 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_unaryExpr_in_multTerms218 = new BitSet(
			new long[] { 0x00000000004E7D22L });
	public static final BitSet FOLLOW_SQRT_in_unaryExpr251 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_factExpr_in_unaryExpr255 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_factExpr_in_unaryExpr261 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_term_in_factExpr278 = new BitSet(
			new long[] { 0x0000000000008002L });
	public static final BitSet FOLLOW_FACT_in_factExpr285 = new BitSet(
			new long[] { 0x0000000000008002L });
	public static final BitSet FOLLOW_LPAREN_in_term301 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_expr_in_term303 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_RPAREN_in_term305 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_LN_in_term311 = new BitSet(
			new long[] { 0x0000000000000100L });
	public static final BitSet FOLLOW_LPAREN_in_term313 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_expr_in_term315 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_RPAREN_in_term317 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_LOG_in_term323 = new BitSet(
			new long[] { 0x0000000000000100L });
	public static final BitSet FOLLOW_LPAREN_in_term325 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_expr_in_term327 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_RPAREN_in_term329 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_SIN_in_term334 = new BitSet(
			new long[] { 0x0000000000000100L });
	public static final BitSet FOLLOW_LPAREN_in_term336 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_expr_in_term338 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_RPAREN_in_term340 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_COS_in_term345 = new BitSet(
			new long[] { 0x0000000000000100L });
	public static final BitSet FOLLOW_LPAREN_in_term347 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_expr_in_term349 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_RPAREN_in_term351 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_TAN_in_term356 = new BitSet(
			new long[] { 0x0000000000000100L });
	public static final BitSet FOLLOW_LPAREN_in_term358 = new BitSet(
			new long[] { 0x00000000004E7D20L });
	public static final BitSet FOLLOW_expr_in_term360 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_RPAREN_in_term362 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_DECIMAL_in_term367 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_PI_in_term376 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_E_in_term386 = new BitSet(
			new long[] { 0x0000000000000002L });
