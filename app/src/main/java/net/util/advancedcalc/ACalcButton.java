...
public class ACalcButton extends ImageButton {
	private final int haptic = HapticFeedbackConstants.VIRTUAL_KEY;

	public ACalcButton(Context context) {
		super(context);
	}

	public ACalcButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public ACalcButton(Context context, AttributeSet attrs, int defStyle) {
