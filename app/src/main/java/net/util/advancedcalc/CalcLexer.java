...
public class CalcLexer extends Lexer {
	...
	public final void mDECIMAL() throws RecognitionException {
		try {
			int _type = DECIMAL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// CalcLexer.g:42:9: ( ( ( DIGIT )+ ( DECIMALPOINT ( DIGIT )* )? |
			// DECIMALPOINT ( DIGIT )+ ) ( 'E' ( MINUS )? ( DIGIT )+ )? )
			// CalcLexer.g:42:11: ( ( DIGIT )+ ( DECIMALPOINT ( DIGIT )* )? |
			// DECIMALPOINT ( DIGIT )+ ) ( 'E' ( MINUS )? ( DIGIT )+ )?
			{
				// CalcLexer.g:42:11: ( ( DIGIT )+ ( DECIMALPOINT ( DIGIT )* )?
				// | DECIMALPOINT ( DIGIT )+ )
	...
	public void mTokens() throws RecognitionException {
		// CalcLexer.g:1:8: ( PLUS | MINUS | MULT | DIV | LPAREN | RPAREN | SIN
		// | COS | TAN | LN | LOG | FACT | POWER | E | PI | SQRT | DECIMALPOINT
		// | DECIMAL | WHITESPACE )
		int alt12 = 19;
	...
	static final String DFA12_eotS = "\20\uffff\1\26\6\uffff";
	static final String DFA12_eofS = "\27\uffff";
	static final String DFA12_minS = "\1\11\6\uffff\1\151\2\uffff\1\156\5\uffff\1\60\6\uffff";
	static final String DFA12_maxS = "\1\u221a\6\uffff\1\161\2\uffff\1\157\5\uffff\1\71\6\uffff";
	static final String DFA12_acceptS = "\1\uffff\1\1\1\2\1\3\1\4\1\5\1\6\1\uffff\1\10\1\11\1\uffff\1\14"
			+ "\1\15\1\16\1\17\1\20\1\uffff\1\22\1\23\1\7\1\12\1\13\1\21";
	static final String DFA12_specialS = "\27\uffff}>";
